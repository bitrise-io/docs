 ...
 *
 * The only change from the original: Hit() also renders the result's
 * top-level category (hierarchy.lvl0) as a breadcrumb line, since
 * DocSearch's own default hit template never shows it per-result — only
 * once, as a group header above a batch of results in the same category.

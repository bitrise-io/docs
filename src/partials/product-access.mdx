...
For details, check out [Updating roles and permissions](/en/bitrise-platform/workspaces/collaboration-and-permissions-in-workspaces/roles-and-permissions-in-workspaces/updating-roles-and-permissions).

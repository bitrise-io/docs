...
- If you use the [GitHub App](/en/bitrise-platform/repository-access/github-app-integration) integration, you can [link additional repositories](/en/bitrise-platform/repository-access/github-app-integration/additional-linked-repositories) to your project.

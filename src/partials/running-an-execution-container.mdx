...
- [Refer to the container in the Step bundle definition](#N1773826090960). When that Step bundle is added to the Workflow, it will run within that container by default, unless you override it within the Workflow.

...
Read more: [Disabling builds from a draft PR](/en/bitrise-ci/run-and-analyze-builds/build-triggers/configuring-build-triggers/skipping-a-build-triggered-by-a-draft-pull-request/disabling-builds-from-a-draft-pr).

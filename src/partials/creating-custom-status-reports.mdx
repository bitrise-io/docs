...
Find the available variables here: [see topic](#table-idm234615903497824).
...
When switching from project-based status reports to Workflow level status reports, you might need to update [branch protection rules](/en/bitrise-ci/configure-builds/configuring-build-settings/reporting-the-build-status-to-your-git-hosting-provider#configuring-build-status-reporting).

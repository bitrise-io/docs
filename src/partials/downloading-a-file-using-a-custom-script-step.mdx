...
1. Add a script to download the file and store the destination path in an Env Var.
   ...
   If you [upload the file to Bitrise](/en/bitrise-ci/run-and-analyze-builds/managing-build-files/uploading-files-for-your-builds.html), you can use the file's download URL in your script.

...
If you do have an AWS account for managing your infrastructure, we recommend checking our [AWS offering](/en/bitrise-platform/infrastructure/bitrise-on-aws--manual-setup.html).

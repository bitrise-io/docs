...
SAML SSO is only available on select plans. Contact our support to find out if SAML SSO is available on your <GlossTerm baseform="workspace">Workspace</GlossTerm>'s plan.

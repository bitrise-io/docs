...
- [Triggers](/en/bitrise-ci/run-and-analyze-builds/build-triggers/configuring-build-triggers.html): You can configure triggers: code push events, pull requests, or tags can all be set up to automatically start builds on Bitrise.
- [Stack](/en/bitrise-build-hub/infrastructure/build-stacks.html): Check out the default stack of your project, select a new one from a dropdown menu or select a specific stack for one of your Workflows.

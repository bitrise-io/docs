...
Our [iOS code signing Steps](/en/bitrise-ci/code-signing/ios-code-signing.html) manage your provisioning profiles for you: they download the profiles from the Apple Developer portal and install them for you. Here’s what you can do if these Steps fail:

...
1. Make sure you have a testing Step in your Workflow.
   ...
   [You must install dependencies](/en/bitrise-ci/getting-started/quick-start-guides/getting-started-with-expo-projects#installing-dependencies-for-ioniccordovareact-apps) before you can run tests.

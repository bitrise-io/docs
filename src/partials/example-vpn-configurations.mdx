...
- [Using an OpenVPN server](#UUID-c06c8ec2-9381-610c-6fed-aa196a13c81e).
- [Using Strongswan VPN](#UUID-0735a420-25a9-490f-306b-a638dc966e3e).
- [Using Cisco VPN](#UUID-8540fef2-571e-8024-d44a-9c2ed8a5ec1e).
...
1. Register the encoded certificates and the key as [Secrets](/en/bitrise-ci/configure-builds/secrets.html).

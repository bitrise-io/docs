...
## Xcode <GlossTerm baseform="stack">stack</GlossTerm> updates

You can select macOS stacks based on the Xcode version you need. Under the hood, one VM image contains multiple Xcode versions installed and your requested Xcode version is activated at runtime before your <GlossTerm baseform="workflow">Workflow</GlossTerm> starts.
...
1. The first Beta version of a new minor Xcode version is released.
1. A new version of an Xcode Beta version is released.
...
**First Beta version of a new major Xcode version**
...
**First Beta version of a new minor Xcode version**
...
**A new Beta version of an Xcode Beta version**
...
1. A new minor Xcode version is released.

**A new major Xcode version**
...
Not all Xcode releases <GlossTerm baseform="trigger">trigger</GlossTerm> a transition. For example, Xcode beta minor version releases do not trigger an Edge to Stable stack transition: the new beta version simply replaces the old one. Xcode patch releases do not trigger an Edge to Stable stack transition. Instead, the Stable stacks will be updated in place with the new patch version.

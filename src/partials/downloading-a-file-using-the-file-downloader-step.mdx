...
1. In the **Download source url** input, add the location where the file can be found.
   ...
   If you [uploaded the file to Bitrise](/en/bitrise-ci/run-and-analyze-builds/managing-build-files/uploading-files-for-your-builds.html), you can find its download URL in the **Files** section of the **App settings** page.

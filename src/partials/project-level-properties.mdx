...
This property contains project-level configuration information, such as [Environment Variables](/en/bitrise-ci/configure-builds/environment-variables.html).
...
Read more: [Setting the stack in the bitrise.yml file](/en/bitrise-ci/configure-builds/configuring-build-settings/setting-the-stack-for-your-builds#setting-the-stack-in-the-bitriseyml-file).

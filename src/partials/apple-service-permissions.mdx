...
In this guide, we'll list the roles based on the two main [authentication methods](/en/bitrise-platform/integrations/apple-services-connection/steps-requiring-apple-authentication.html): API key authentication and Apple ID authentication.

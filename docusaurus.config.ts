...
/**
 * Walk a sidebar item tree and replace the items of the "API reference"
 * subcategory (identified by `customProps.isApiEndpoints === true`) with the
 * tag-grouped sidebar generated by docusaurus-plugin-openapi-docs.  The outer
 * "Release Management API" category is left intact so the Introduction page
 * remains a direct child alongside the "API reference" subcategory.
 */
...
const config: Config = {
  ...
  markdown: {
    ...
    preprocessor: ({filePath, fileContent}) => {
      ...
      // Skip auto-generated API reference files — they use openapi-docs theme
      // components that are not in the ALLOWED set, and their JSX is already valid.
      ...
      const ALLOWED = new Set([
        ...
        // openapi-docs theme components (used in generated api-reference files)
        'StatusCodes', 'MethodEndpoint', 'ParamsDetails', 'RequestSchema',
        'OperationTabs', 'SchemaTabs', 'ApiLogo', 'Heading', 'Translate', 'Export',
      ]);
    ...
    [
      'classic',
      {
        docs: {
          ...
          // Replace the flat autogenerated list inside the "Release Management API"
          // category with tag-grouped items produced by docusaurus-plugin-openapi-docs.

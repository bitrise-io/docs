...
The [key-value cache](/bitrise-ci/dependencies-and-caching/key-based-caching/using-key-based-caching) stores whole files and directories you designate (like `~/.gradle/caches`) so they persist between builds on ephemeral CI runners. All three are complementary and can be used together.

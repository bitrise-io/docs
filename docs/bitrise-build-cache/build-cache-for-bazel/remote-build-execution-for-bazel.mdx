...
1. Set up the Bitrise Build Cache for Bazel: [Configuring the build cache for Bazel in the Bitrise CI environment](/en/bitrise-build-cache/build-cache-for-bazel/configuring-the-build-cache-for-bazel-in-the-bitrise-ci-environment).
...
1. Start setting up the Bitrise Build Cache for Bazel: [Configuring the build cache for Bazel in other CI environments](/en/bitrise-build-cache/build-cache-for-bazel/configuring-the-build-cache-for-bazel-in-other-ci-environments).
...
1. Start setting up the Bitrise Build Cache for Bazel: [Configuring the build cache for Bazel in local builds](/en/bitrise-build-cache/build-cache-for-bazel/configuring-the-build-cache-for-bazel-in-local-builds).

---
title: "Configuring the Build Cache for Bazel in non-Bitrise CI environments"
sidebar_position: 2
slug: /bitrise-build-cache/build-cache-for-bazel/configuring-the-build-cache-for-bazel-in-non-bitrise-ci-environments
---
...
There is a dedicated guide with GitHub Actions workflow examples: [Configuring the Build Cache for Bazel in GitHub Actions](/bitrise-build-cache/build-cache-for-bazel/configuring-the-build-cache-for-bazel-in-github-actions).

...
1. [Find your <GlossTerm baseform="Workspace">Workspace</GlossTerm> ID](/en/bitrise-ci/api/identifying-<GlossTerm baseform="workspace">workspaces</GlossTerm>-and-apps-with-their-slugs): open the **Workspace settings** page and select **General settings** on the left navigation menu. You can find and copy the slug from there.

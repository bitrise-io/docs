...
You can add the activation either through the <GlossTerm baseform="workflow editor">Workflow Editor</GlossTerm> or directly in `bitrise.yml`.
...
<Tabs>
  ...
  1. Select the <GlossTerm baseform="workflow">Workflow</GlossTerm> you need.
  1. Add the **Build Cache for React Native** step *before* any <GlossTerm baseform="step">Step</GlossTerm> that <GlossTerm baseform="trigger">triggers</GlossTerm> a native build.

...
Install both with Homebrew (**recommended**):
...
Or, without Homebrew, install the CLI with the installer script and [download `ccache`](https://ccache.dev/download.html) manually:

...
To add a new release to [a connected app](/release-management/getting-started-with-release-management/connecting-an-app):
...
After successfully adding a release, you can modify its configuration at any time: [Configuring a release](/release-management/releases/configuring-a-release/configuring-auto-upload).

...
1. Sign up for Bitrise and [add a new Bitrise CI project](/bitrise-build-cache/getting-started-with-the-build-cache/getting-started-with-the-build-cache#adding-a-new-connection-to-the-build-cache).
1. [Connect an app](/release-management/getting-started-with-release-management/connecting-an-app) in Release Management.

   This includes setting up your project's connection to App Store Connect and/or Google Play.
1. [Use our API to upload an installable artifact](/release-management/installable-artifacts).
1. Select this artifact at the [release candidate stage](/release-management/releases/managing-the-release-process/selecting-a-release-candidate).

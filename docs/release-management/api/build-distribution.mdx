...
To act on an artifact you didn't just upload yourself, look it up with [`GET /installable-artifacts`](/en/release-management-api/apps/api-reference/list-installable-artifacts):

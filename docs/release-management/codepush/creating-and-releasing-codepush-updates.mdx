...
- A Bitrise API token: it can be either a [personal access token](/en/bitrise-platform/accounts/personal-access-tokens) or a [workspace API token](/en/bitrise-platform/<GlossTerm baseform="workspace">workspaces</GlossTerm>/workspace-api-token).

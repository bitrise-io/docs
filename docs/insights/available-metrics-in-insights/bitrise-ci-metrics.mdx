...
- Git operations: [Git Insights](/insights/git-insights).

## Build metrics

You can access build metrics from the charts on the **Overview** page or by selecting **Builds** on the left. The build metrics are available on app-, <GlossTerm baseform="Pipeline">Pipeline</GlossTerm>, Stage, <GlossTerm baseform="Workflow">Workflow</GlossTerm>-, and <GlossTerm baseform="Step">Step</GlossTerm> level as well:

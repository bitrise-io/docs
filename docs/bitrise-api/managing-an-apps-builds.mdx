...
sidebar_custom_props:
  icon: "Tasks"
slug: /bitrise-api/managing-an-app-s-builds
---
...
The full list of parameters can be found in the [API reference](/en/bitrise-api/api-reference) documentation.
...
- You can use the `GET/apps/{app-slug}/archived-builds` API endpoint: [Listing the archived builds of an app](/en/bitrise-api/managing-an-app-s-builds#listing-the-archived-builds-of-an-app).
...
You can try any of these endpoints in the [API reference](/en/bitrise-api/api-reference) documentation.

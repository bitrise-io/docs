...
sidebar_custom_props:
  icon: "Folder"
slug: /bitrise-api/managing-files-in-generic-file-storage
---
...
| --- | --- | --- |
| [POST/apps/\{app-slug\}/generic-project-files](/en/bitrise-api/api-reference) | Create a generic project file | Owner or Admin |
| [POST/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}/uploaded](/en/bitrise-api/api-reference) | Confirm the upload process | Owner or Admin |
| [PATCH/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/en/bitrise-api/api-reference) | Update an uploaded project file | Owner or Admin |
| [GET/apps/\{app-slug\}/generic-project-files](/en/bitrise-api/api-reference) | Get a list of the uploaded project files | Owner or Admin |
| [GET/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/en/bitrise-api/api-reference) | Retrieve data of a specific project file | Owner or Admin |
| [DELETE/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/en/bitrise-api/api-reference) | Delete an uploaded project file | Owner or Admin |

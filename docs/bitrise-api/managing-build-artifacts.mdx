...
sidebar_custom_props:
  icon: "Install"
slug: /bitrise-api/managing-build-artifacts
---
...
| --- | --- | --- |
| [GET/apps/\{app-slug\}/builds/\{build-slug\}/artifacts](/en/bitrise-api/api-reference) | Listing build artifacts | Any |
| [GET/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/en/bitrise-api/api-reference) | Retrieving data of a specific build artifact | Any |
| [PATCH/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/en/bitrise-api/api-reference) | Updating a build artifact | Owner, Admin, or Developer |
| [DELETE/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/en/bitrise-api/api-reference) | Deleting a build artifact | Owner, Admin, or Developer |

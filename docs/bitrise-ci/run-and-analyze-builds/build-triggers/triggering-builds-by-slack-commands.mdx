...
You can <GlossTerm baseform="trigger">trigger</GlossTerm> Bitrise builds from your Slack <GlossTerm baseform="workspace">workspace</GlossTerm> by configuring [Slash Commands](https://api.slack.com/interactivity/slash-commands) in your Slack apps. Each Bitrise app needs its own Slash Command.
...
Without specifying either branch or <GlossTerm baseform="workflow">Workflow</GlossTerm> in your command, the command will fail.

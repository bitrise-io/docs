...
You can change the build number manually on the web UI. For details, see: [Changing the build number on the web UI](/bitrise-ci/run-and-analyze-builds/build-numbering-and-app-versioning#changing-the-build-number-on-the-web-ui).

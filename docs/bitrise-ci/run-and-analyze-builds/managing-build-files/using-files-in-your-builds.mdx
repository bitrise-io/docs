...
- You can [upload a file to the Generic File Storage](/bitrise-ci/run-and-analyze-builds/managing-build-files/uploading-files-for-your-builds) and use the automatically generated Env Var as a Step input value in Steps that accept URLs as an input.
...
1. In the **Download source url** input, add the location where the file can be found.
   ...
   If you [uploaded the file to Bitrise](/bitrise-ci/run-and-analyze-builds/managing-build-files/uploading-files-for-your-builds), you can find its download URL in the **Files** section of the **App settings** page.
...
1. Add a script to download the file and store the destination path in an Env Var.
   ...
   If you [upload the file to Bitrise](/bitrise-ci/run-and-analyze-builds/managing-build-files/uploading-files-for-your-builds), you can use the file's download URL in your script.

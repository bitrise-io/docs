...
You don't need to set anything up or opt in. [Set the Linux Small machine type for a Workflow](/en/bitrise-ci/configure-builds/configuring-build-settings/setting-the-stack-for-your-builds) and qualifying builds are automatically excluded from your build count.

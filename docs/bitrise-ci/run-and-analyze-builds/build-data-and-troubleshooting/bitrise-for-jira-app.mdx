...
- A dedicated **Bitrise builds** section, where you can also re-run or abort a build.
  ...
  ![Bitrise builds section on a Jira issue, showing a pipeline and a build](/img/2026-08-10-jira-app-new-bitrise-section-pipeline-build.png)

- The **Builds** tab of Jira's standard development panel.

  ![Builds tab of Jira's development panel, showing build status](/img/2026-08-10-jira-app-generic-development-section-builds-tab.png)
...
1. Click **Create token** and follow [Creating a Workspace API token](/bitrise-platform/workspaces/workspace-api-token), with these settings:
...
1. [Create a personal access token](/bitrise-platform/accounts/personal-access-tokens).
...
- [Workspace API token](/bitrise-platform/workspaces/workspace-api-token)
- [Personal access tokens](/bitrise-platform/accounts/personal-access-tokens)

...
If your project’s repository contains any UI or unit tests, you can run them by using the appropriate testing <GlossTerm baseform="step">Steps</GlossTerm> in your <GlossTerm baseform="workflow">Workflow</GlossTerm>. With the **Deploy to Bitrise.io** Step, your test results will be displayed in our **[test reports](/en/bitrise-ci/testing/deploying-and-viewing-test-results)** page and you can also see them on GitHub Checks, too.

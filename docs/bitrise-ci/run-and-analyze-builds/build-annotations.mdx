...
Build Annotations allow you to add relevant build information directly on the <NT>Bitrise</NT> <NT>build details</NT> page, simplifying the process of accessing crucial data during build progression and debugging.
...
1. Add a <NT><GlossTerm baseform="Step">Step</GlossTerm></NT> capable of running custom commands.

   For example, **Script** or **fastlane**.
1. Add a command to install the <NT>Bitrise</NT> Annotations plugin:

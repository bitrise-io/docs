...
You can also download the current `bitrise.yml` configuration of your app and run it locally with the [Installing and updating the Bitrise CLI](/bitrise-ci/bitrise-cli/installing-and-updating-the-bitrise-cli).

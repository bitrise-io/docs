...
1. [Connect a repo](/en/bitrise-platform/getting-started/getting-started-with-the-bitrise-platform)and run an automatically configured standard <GlossTerm baseform="workflow">Workflow</GlossTerm> on any <GlossTerm baseform="project">project</GlossTerm>.
...
1. After getting to your new Workflow’s first green build, set up other jobs by configuring [automatic triggers](/en/bitrise-ci/run-and-analyze-builds/build-<GlossTerm baseform="trigger">triggers</GlossTerm>/configuring-build-triggers) or [scheduled builds](/en/bitrise-ci/run-and-analyze-builds/starting-builds/scheduling-builds).
...
### Environment Variables and <GlossTerm baseform="secret">Secrets</GlossTerm> on Bitrise

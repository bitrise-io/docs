...
Bitrise takes care of all of the above. We have a vast array of automatized Steps, [API](/en/bitrise-ci/api/api-overview), [CLI](/en/bitrise-ci/bitrise-cli/installing-and-updating-the-bitrise-cli), and [up-to-date Stacks](https://stacks.bitrise.io) with a highly intuitive GUI, called Workflow Editor, all available at your fingertips.
...
1. [Connect a repo](/en/bitrise-platform/getting-started/getting-started-with-the-bitrise-platform)and run an automatically configured standard Workflow on any project.

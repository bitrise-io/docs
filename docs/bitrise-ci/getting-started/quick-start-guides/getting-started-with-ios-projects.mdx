...
You can run your fastlane lane on Bitrise with the same commands you would use locally. Bitrise’s automated Step provides extra functionality to your lane and speed up your builds: [fastlane Step](https://bitrise.io/integrations/steps/fastlane).

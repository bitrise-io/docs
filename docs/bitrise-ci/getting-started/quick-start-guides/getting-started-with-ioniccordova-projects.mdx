...
## Adding an Ionic/Cordova <GlossTerm baseform="project">project</GlossTerm> to Bitrise
...
1. Select **Yes, auto-detect configuration**. Bitrise will scan your repository and attempt to set up a <GlossTerm baseform="stack">stack</GlossTerm> and default <GlossTerm baseform="workflow">Workflows</GlossTerm> based on the results of the scan. In most cases, we recommend choosing this option.
   ...
   :::
1. At **Project Build configuration**, you can select which platform to build your app for. You can select:

   - iOS.
   - Android.
   - iOS and Android (where the Android build gets built first).

   ![Cordova_apps.png](/img/_paligo/uuid-73f89e6b-1f74-1d1d-8947-e06b996648ba.png)

   ![Cordova_apps.png](/img/_paligo/uuid-69f86006-5ed4-0af7-716e-220d09da2165.png)

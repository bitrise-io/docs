...
1. Make sure the appropriate [service credential user](/bitrise-platform/integrations/the-service-credential-user) is set on the **Integrations** page.
...
1. Click **Add path** .
   ...
   - The [service credential user](/bitrise-platform/integrations/the-service-credential-user) isn't set correctly or doesn't have admin rights to the repo.

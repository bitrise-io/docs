...
:::caution[Using build <GlossTerm baseform="trigger">triggers</GlossTerm> instead]
...
The **Selective builds** setting provides change detection for your builds. Enabling it allows you to only <GlossTerm baseform="Trigger">trigger</GlossTerm> a build of an <GlossTerm baseform="App">app</GlossTerm> if certain files or folders have been modified.
...
:::important[Selective Builds with non-Github <GlossTerm baseform="project">projects</GlossTerm>]

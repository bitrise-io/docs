...
The **Selective builds** setting provides change detection for your builds. Enabling it allows you to only trigger a build of an <GlossTerm baseform="App">app</GlossTerm> if certain files or folders have been modified.

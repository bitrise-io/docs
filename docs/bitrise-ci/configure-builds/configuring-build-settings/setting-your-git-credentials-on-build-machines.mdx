...
Git has various basic [Environmental Variables](https://git-scm.com/book/en/v2/Git-Internals-Environment-Variables) similar to [Bitrise Env Vars](/en/bitrise-ci/configure-builds/environment-variables). If you would like to reduce the amount of Steps in your Workflow, you can set up Env Vars in Bitrise utilizing specific Git Environmental Variables:

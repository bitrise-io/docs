...
<Tabs>
  ...
  1. Add the [**Android Lint**](https://github.com/bitrise-steplib/bitrise-step-android-lint) Step to your Android app's <GlossTerm baseform="Workflow">Workflow</GlossTerm>.
  ...
  1. In the <GlossTerm baseform="configuration yaml">Configuration YAML</GlossTerm> file, add the `android-lint` Step to your Android app's Workflow.
     ...
     my-workflow:
       steps:
         ...
         - android-lint:
             ...
             - project_location: $BITRISE_SOURCE_DIR
     ```
  1. The `arguments` input allows you to pass arguments to the Gradle task.

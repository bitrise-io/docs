...
1. Add the [**Deploy to Bitrise.io - Build Artifacts, Test Reports, and Pipeline intermediate files**](https://github.com/bitrise-steplib/steps-deploy-to-bitrise-io) Step to the end of your Workflow to be able to access the generated artifacts either [on the **Artifacts** tab](/en/bitrise-ci/run-and-analyze-builds/managing-build-files/build-artifacts-online.html) or in the **Tests** tab.

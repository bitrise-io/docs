...
1. Go to repository’s **Settings** tab on Codecov and copy the repository upload token.
   ...
   ![pic1.jpg](/img/_paligo/uuid-c8804850-f923-c194-e029-59d1d39e50d7.png)
1. Add the **Codecov** Step to your Workflow on Bitrise. Make sure you add the Step after the Steps that test and collect coverage.
   ...
   ![pic2.jpg](/img/_paligo/uuid-a0f5c42f-1f2c-8d2b-a381-5c37bb4fe37c.png)
1. Add the Codecov upload token as a secret variable, `CODECOV_TOKEN`, and set the **Expose for Pull Requests** option to `true`. Click **Add new**.
   ...
   ![pic3.jpg](/img/_paligo/uuid-cc9dfa1f-9277-fe9e-7d4a-92d5fb04d5d6.png)

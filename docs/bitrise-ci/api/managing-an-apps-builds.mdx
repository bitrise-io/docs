...
| GET /apps/\{app-slug\}/builds/\{build-slug\}/<GlossTerm baseform="bitrise.yml">bitrise.yml</GlossTerm> | Get the `bitrise.yml` file of one of the builds of a specified app. | Developer |

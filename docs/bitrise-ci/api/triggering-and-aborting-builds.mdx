...
You can trigger and abort builds with the Bitrise API. Define parameters for the build: for example, branch, tag or git commit to use. Custom [Environment Variables](/en/bitrise-ci/configure-builds/environment-variables) can be defined as well.

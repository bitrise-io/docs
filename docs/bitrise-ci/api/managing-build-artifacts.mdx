...
| --- | --- | --- |
| [GET/apps/\{app-slug\}/builds/\{build-slug\}/artifacts](/bitrise-api/api-reference/bitrise-api) | Listing build artifacts | Any |
| [GET/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/bitrise-api/api-reference/bitrise-api) | Retrieving data of a specific build artifact | Any |
| [PATCH/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/bitrise-api/api-reference/bitrise-api) | Updating a build artifact | Owner, Admin, or Developer |
| [DELETE/apps/\{app-slug\}/builds/\{build-slug\}/artifacts/\{artifact-slug\}](/bitrise-api/api-reference/bitrise-api) | Deleting a build artifact | Owner, Admin, or Developer |

...
If you add the `Deploy to bitrise.io` <NT><GlossTerm baseform="Step">Step</GlossTerm></NT> to your <NT><GlossTerm baseform="Workflow">Workflow</GlossTerm></NT>, once the build has run, you can access the build artifacts in the build's **<NT>Artifacts</NT>** tab on bitrise.io.

You can also manage the generated artifacts with the <NT>Bitrise</NT> API.

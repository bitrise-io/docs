...
You can add new <GlossTerm baseform="project">projects</GlossTerm> on Bitrise with the API: add the project, generate SSH keys, and set up the project’s initial configuration.

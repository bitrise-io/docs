...
Reverting to OAuth via API is not fully supported. Reverting <GlossTerm baseform="project">projects</GlossTerm> to OAuth requires manual intervention through the Bitrise UI. Customers should test the migration process with a subset of projects before executing bulk migrations.

...
| --- | --- | --- |
| [POST/apps/\{app-slug\}/generic-project-files](/bitrise-api/api-reference/bitrise-api) | Create a generic project file | Owner or Admin |
| [POST/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}/uploaded](/bitrise-api/api-reference/bitrise-api) | Confirm the upload process | Owner or Admin |
| [PATCH/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/bitrise-api/api-reference/bitrise-api) | Update an uploaded project file | Owner or Admin |
| [GET/apps/\{app-slug\}/generic-project-files](/bitrise-api/api-reference/bitrise-api) | Get a list of the uploaded project files | Owner or Admin |
| [GET/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/bitrise-api/api-reference/bitrise-api) | Retrieve data of a specific project file | Owner or Admin |
| [DELETE/apps/\{app-slug\}/generic-project-files/\{generic-project-file-slug\}](/bitrise-api/api-reference/bitrise-api) | Delete an uploaded project file | Owner or Admin |
...
Get a list of a project's files that were [uploaded to the Generic File Storage](/bitrise-ci/run-and-analyze-builds/managing-build-files/artifact-retention-policy) using the `GET` method. Please note that the **maximum number of files is 50**.

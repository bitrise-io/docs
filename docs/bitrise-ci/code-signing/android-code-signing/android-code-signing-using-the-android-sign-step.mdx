...
1. Add the [**Android Sign**](https://github.com/bitrise-steplib/steps-sign-apk) Step to your <GlossTerm baseform="workflow">Workflow</GlossTerm> after the Step that builds your APK or AAB file.

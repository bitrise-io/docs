...
If a Step requires the keystore file, make sure to include that Step AFTER the [**File Downloader**](https://bitrise.io/integrations/steps/file-downloader) Step.

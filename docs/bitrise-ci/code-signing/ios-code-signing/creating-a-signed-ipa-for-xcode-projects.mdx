...
For a comprehensive overview on what <GlossTerm baseform="step">Steps</GlossTerm> are available for code signing asset management, visit the [iOS code signing page](/en/bitrise-ci/code-signing/ios-code-signing/creating-a-signed-ipa-for-xcode-<GlossTerm baseform="project">projects</GlossTerm>).
...
<Tabs>
  ...
  1. Make sure you have the [**Xcode Archive & Export for iOS**](https://github.com/bitrise-steplib/steps-xcode-archive) Step in your <GlossTerm baseform="workflow">Workflow</GlossTerm>.

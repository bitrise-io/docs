...
You can use any existing version of a <GlossTerm baseform="step">Step</GlossTerm> in your <GlossTerm baseform="workflow">Workflows</GlossTerm>, and different versions of the same Step in different Workflows.

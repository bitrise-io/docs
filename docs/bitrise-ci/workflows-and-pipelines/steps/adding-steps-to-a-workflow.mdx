...
## Adding Steps in the <GlossTerm baseform="workflow editor">Workflow Editor</GlossTerm>
...
If you don't want a Step to run but want to keep the Step configuration intact, you can disable the Step: [Enabling or disabling a Step conditionally](/en/bitrise-ci/workflows-and-<GlossTerm baseform="pipeline">pipelines</GlossTerm>/steps/enabling-or-disabling-a-step-conditionally).

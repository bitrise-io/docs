...
This guide is about creating a Workflow in the Workflow Editor. For YAML configuration syntax, check out [Workflow level properties](/en/bitrise-ci/references/configuration-yaml-reference/workflow-level-properties).

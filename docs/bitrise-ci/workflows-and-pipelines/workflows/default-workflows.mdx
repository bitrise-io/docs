...
When you add a new <GlossTerm baseform="project">project</GlossTerm> on [bitrise.io](https://www.bitrise.io), we create initial <GlossTerm baseform="Pipeline">Pipelines</GlossTerm> and <GlossTerm baseform="Workflow">Workflows</GlossTerm> for you. These are called default <GlossTerm baseform="pipeline">Pipelines</GlossTerm> and <GlossTerm baseform="workflow">Workflows</GlossTerm>. A default Pipeline consists of default Workflows.
...
The <GlossTerm baseform="project scanner">project scanner</GlossTerm> can detect Java projects and create default Workflows for them. A new project is considered a generic Java project if:

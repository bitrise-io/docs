...
| --- | --- | --- |
| `run_tests` | Run your Xcode tests and get the test report. | The Workflow clones your Git repository, caches and installs your project’s dependencies if any, runs your Xcode tests and saves the test results. |

...
A <NT>Bitrise</NT> <NT>Pipeline</NT> is the top level of our CI/CD configuration. <NT>Pipelines</NT> can be used to organize the entire CI/CD process and to set up advanced configurations with multiple different tasks running parallel and/or sequentially.
...
Read more about <NT>Pipelines</NT>:

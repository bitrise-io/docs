...
If you think your <GlossTerm baseform="Step">Step</GlossTerm> can be of use to others, you can share it! Before doing so, however, please check that there are no other <GlossTerm baseform="step">Steps</GlossTerm> that solve the same problem. You can check:
...
1. Run the [share process](/en/bitrise-ci/workflows-and-<GlossTerm baseform="pipeline">pipelines</GlossTerm>/developing-your-own-bitrise-step/sharing-steps-with-all-bitrise-users#sharing-a-new-step) again.

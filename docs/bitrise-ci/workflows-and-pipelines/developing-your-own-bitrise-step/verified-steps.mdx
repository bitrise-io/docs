...
We strongly recommend that you consult with our [Step development](/bitrise-ci/workflows-and-pipelines/developing-your-own-bitrise-step/developing-a-new-step) guidelines before creating a Step.
...
- Be familiar with our [Stack update policy](/bitrise-build-hub/infrastructure/build-stacks/macos-stack-update-policy), especially the cadence of breaking changes. Your Step might (accidentally or on purpose) depend on tools from the stack environment, and we don’t want Steps to be broken after stack updates.

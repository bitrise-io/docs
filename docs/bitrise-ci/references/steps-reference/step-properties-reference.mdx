...
<GlossTerm baseform="Step">Step</GlossTerm> properties provide important data of a Step, such as its <GlossTerm baseform="project">project</GlossTerm> type, its source code or the dependencies it requires. A Step’s inputs and outputs are also defined as Step properties. Let’s take a look at the properties!

...
The <GlossTerm baseform="Step">Step</GlossTerm> data and information you specify in the `<GlossTerm baseform="bitrise.yml">bitrise.yml</GlossTerm>` file are the parameters of the <GlossTerm baseform="step">Step</GlossTerm> you want to change, compared to the Step’s default definition.

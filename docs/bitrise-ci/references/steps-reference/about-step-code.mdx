...
To include Steps in your <GlossTerm baseform="Workflow">Workflow</GlossTerm>, you have to reference them in the configuration YAML file of your project. To do so, you will need the correct reference format for the Step. In the configuration file, you can also specify input values for the inputs defined in the Step's interface definition.

...
1. The StepLib source: a library of <GlossTerm baseform="step">Step</GlossTerm> repositories, such as the official [Bitrise Step Library](https://github.com/bitrise-steplib).
...
This is useful for Step development. It can also be used if you want to include your build Steps in your <GlossTerm baseform="project">project</GlossTerm>’s source code.

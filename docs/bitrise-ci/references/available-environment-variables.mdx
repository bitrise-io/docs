...
[Environment Variables](/en/bitrise-ci/configure-builds/environment-variables) (Env Vars) consist of a key and a value. They can also include optional attributes. They can be defined on the level of apps, <GlossTerm baseform="Workflow">Workflows</GlossTerm> or <GlossTerm baseform="Step">Steps</GlossTerm>.
...
| $BITRISE_WORKSPACE_ID | The [workspace slug](/en/bitrise-api/identifying-workspaces-and-apps-with-their-slugs) of the workspace that owns the project. |

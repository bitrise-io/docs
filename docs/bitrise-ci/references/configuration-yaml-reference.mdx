...
- Read more about where to store the configuration YAML file: [Managing a project's configuration YAML file](/en/bitrise-ci/configure-builds/configuration-yaml/storing-an-apps-configuration-yaml).

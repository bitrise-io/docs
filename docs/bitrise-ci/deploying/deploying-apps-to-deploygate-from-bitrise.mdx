...
This <GlossTerm baseform="step">Step</GlossTerm> should be added after the Step that builds your app's binary that will be uploaded. You need to set several required parameters as below:
...
You can also generate a distribution page when you upload an app from Bitrise with [DeployGate Upload](https://github.com/DeployGate/upload-app-bitrise-step) Step. Please refer to the optional variables above.

...
To upload your app to DeployGate, add the `DeployGate Upload` <GlossTerm baseform="Step">Step</GlossTerm> to your bitrise <GlossTerm baseform="Workflow">Workflow</GlossTerm>.

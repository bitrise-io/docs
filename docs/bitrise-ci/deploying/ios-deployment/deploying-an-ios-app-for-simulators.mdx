...
The .app file can be run on any simulator. On Bitrise, we have a <GlossTerm baseform="step">Step</GlossTerm> to upload your <GlossTerm baseform="App">app</GlossTerm> to Appetize.io: the [**Appetize.io deploy**](https://github.com/bitrise-steplib/steps-appetize-io-deploy) Step. With this Step, you can deploy your app so you can run it in a browser.

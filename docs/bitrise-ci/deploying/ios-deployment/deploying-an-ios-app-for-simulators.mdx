...
The .app file can be run on any simulator. On Bitrise, we have a Step to upload your <GlossTerm baseform="App">app</GlossTerm> to Appetize.io: the **Appetize.io deploy** Step. With this Step, you can deploy your app so you can run it in a browser.

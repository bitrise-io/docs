...
1. Set the **Distribution method** input of the <GlossTerm baseform="step">Step</GlossTerm> to `development`.
...
1. Make sure the [**Deploy to Bitrise.io - Build Artifacts, Test Reports, and Pipeline intermediate files**](https://github.com/bitrise-steplib/steps-deploy-to-bitrise-io) Step is in your <GlossTerm baseform="workflow">Workflow</GlossTerm>.

...
1. Add the **Applivery iOS Deploy** or the **Applivery Android Deploy** <GlossTerm baseform="Step">Step</GlossTerm> to your <GlossTerm baseform="Workflow">Workflow</GlossTerm>. Make sure you add the <GlossTerm baseform="step">Step</GlossTerm> after the Steps that build your <GlossTerm baseform="App">app</GlossTerm>.
...
1. Open your app on Bitrise and click the **<GlossTerm baseform="workflow">Workflows</GlossTerm>** tab to open the <GlossTerm baseform="workflow editor">Workflow Editor</GlossTerm>.
...
| App Token | String | Applivery App token. By default gets $APPLIVERY_APP_TOKEN <GlossTerm baseform="Secret">Secret</GlossTerm> var. |
| Changelog | String | Additional build/release notes or changelog attached to the deploy. |
| Notify Collaborators? | Boolean | Automatically notify your <GlossTerm baseform="project">project</GlossTerm> Collaborators vía emai. |

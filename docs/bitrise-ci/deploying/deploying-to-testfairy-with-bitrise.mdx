...
To deploy your <GlossTerm baseform="App">app</GlossTerm> on the TestFairy platform you just simply need to add the **TestFairy** <GlossTerm baseform="Step">Step</GlossTerm> to your app’s <GlossTerm baseform="Workflow">Workflow</GlossTerm> (on [bitrise.io](https://www.bitrise.io)).
...
You can also enable or disable the email notifications and set the tester groups you would like to notify. There’s an option to make your users always upgrade to the latest build by enabling Auto update in the <GlossTerm baseform="step">Step</GlossTerm>, and you can also start recording video and set the length of it.

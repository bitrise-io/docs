...
Mentions of Linux stack update policy has been moved on its own page, [Linux stack update policy](/bitrise-build-hub/infrastructure/build-stacks/linux-stack-update-policy), with more information on Edge, Stable and Frozen stacks. It also describes the yearly cadence of new Linux stacks, as well as the deprecation and removal of older Linux stacks.

Removed how to use previous versions of a stack from this page and added it to [Stack update policy](/bitrise-build-hub/infrastructure/build-stacks/stack-update-policy).

...
Each workspace has an owner, and members can be assigned a workspace role — Viewer, Contributor, or Manager — that defines their access to the workspace itself. Members can be sorted into groups: groups allow owners to quickly assign large teams to specific projects.

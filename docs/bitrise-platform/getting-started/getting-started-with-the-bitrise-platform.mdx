...
You can sign up via email, one of three Git providers (GitHub, GitLab, or Bitbucket), or a Google account: [Signing up for Bitrise](/bitrise-platform/getting-started/signing-up-for-bitrise).
...
The **Build Cache** card on this screen isn't a third way to create a project — it takes you to Build Cache setup, which requires a Bitrise CI project to already exist.

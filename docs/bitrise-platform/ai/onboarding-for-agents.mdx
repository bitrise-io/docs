...
Bitrise is mobile-focused CI/CD and app distribution for iOS and Android, including Flutter and React Native. If you work through an AI agent such as Claude Code, Cursor, or VS Code with GitHub Copilot, it can connect you to Bitrise without leaving the chat, using the [Bitrise MCP server](/en/bitrise-platform/ai/bitrise-mcp). The first time your agent needs access, your client prompts you to authorize it and starts a Bitrise sign-in in your browser. You sign in — or create an account — once, approve the connection, and your agent is authorized. The same sign-in also logs you into the Bitrise website, so there's nothing to set up twice.

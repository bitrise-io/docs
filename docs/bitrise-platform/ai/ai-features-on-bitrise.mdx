...
The AI build fixer requires the AI build summary to be enabled first.
...
Bitrise MCP supports multiple AI clients, including Claude, Cursor, VS Code, Windsurf, Gemini CLI, and AWS Kiro. See [Bitrise MCP](/bitrise-platform/ai/bitrise-mcp) for the full list of supported clients and setup instructions.

...
{/* The id is pinned to the pre-RDE heading text so existing #managing-workspace-roles-via-scim links keep resolving. */}

## Managing workspace and product roles via SCIM {#managing-workspace-roles-via-scim}

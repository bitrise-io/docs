...
## [Xcode Archive & Export for iOS](https://bitrise.io/integrations/steps/xcode-archive) Step
...
Exports an IPA from an existing iOS and tvOS .xcarchive file. You can add multiple Export iOS and tvOS Xcode archive Steps to your <GlossTerm baseform="Workflow">Workflows</GlossTerm> to create multiple different signed IPA files.

...
[Connecting to an Apple service with API key](/bitrise-platform/integrations/apple-services-connection/connecting-to-an-apple-service-with-api-key)

[Connecting to an Apple service with Apple ID](/bitrise-platform/integrations/apple-services-connection/connecting-to-an-apple-service-with-apple-id)

[Authenticating in a Step with API key](/bitrise-platform/integrations/apple-services-connection/connecting-to-an-apple-service-with-step-inputs#authenticating-in-a-step-with-api-key)
...
[Connecting to an Apple Service with Step inputs](/bitrise-platform/integrations/apple-services-connection/connecting-to-an-apple-service-with-step-inputs)

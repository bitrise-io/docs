...
In this guide, we'll list the roles based on the two main [authentication methods](/bitrise-platform/integrations/apple-services-connection/steps-requiring-apple-authentication): API key authentication and Apple ID authentication.
...
Read more about the different distribution methods: [Creating a signed IPA for Xcode projects](/bitrise-ci/code-signing/ios-code-signing/creating-a-signed-ipa-for-xcode-projects).

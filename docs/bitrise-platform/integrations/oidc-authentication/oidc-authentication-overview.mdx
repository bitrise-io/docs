...
- To enable your Bitrise builds to authenticate to external systems such as AWS, GCP, Azure, container registries, <GlossTerm baseform="secret">secret</GlossTerm> management or artifact stores.

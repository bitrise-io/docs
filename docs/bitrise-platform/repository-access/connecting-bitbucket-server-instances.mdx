...
1. In the **Redirect URI** field, enter https://app.bitrise.io/users/auth/bitbucket_server/callback.
...
1. Add your credentials:
   ...
   - **App ID**: The Client ID you copied from Bitbucket Server
   - **Secret**: The Client secret you copied from Bitbucket Server

...
For private projects with OAuth connections, Bitrise uses SSH to access Git repositories: to grant access, you need to make sure all the repositories can be accessed with the public [SSH key generated](/en/bitrise-platform/repository-access/configuring-ssh-keys) for your Bitrise <GlossTerm baseform="project">project</GlossTerm>.
...
1. Make sure you have the **Activate SSH Key** Step and the **Git Clone** Step at the start of your <GlossTerm baseform="workflow">Workflow</GlossTerm>.

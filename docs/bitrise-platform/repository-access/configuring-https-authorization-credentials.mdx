...
For private projects, you can authorize Bitrise to access your repository via an HTTPS URL, using a Personal Access Token. This is necessary for Bitrise to be able to clone your repository to the [virtual machine](/en/bitrise-platform/infrastructure/build-machines.html) when starting a new build. You can set up authorization:

- [When adding a new project](/en/bitrise-ci/getting-started/adding-a-new-project.html).
- At any time on the **Project settings** page.
...
1. Make sure you have an HTTPS URL: on the left, select **General**, and in the **Basic settings** section, find the **Repository URL**.
1. On the left, select **Integrations**.
1. Select the **Git provider** tab.
1. In the **Personal Access Token** card, click **Add**.

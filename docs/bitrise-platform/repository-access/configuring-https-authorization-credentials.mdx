...
- [When adding a new project](/bitrise-ci/getting-started/adding-a-new-project).
...
1. Make sure you have an HTTPS URL: on the left, select **Basic settings**, and find the **Repository URL**.
1. On the left, select **Repository**.
1. In the **Authorization** section, find the **Authorization method** card, and click **Add credentials**.

...
| Builds | Approve build requests | Turn manual pull request build approval on or off, and approve individual pull request builds. Today implicit to Admin and Owner. See [Approving pull request builds](/bitrise-ci/run-and-analyze-builds/starting-builds/approving-pull-request-builds). |

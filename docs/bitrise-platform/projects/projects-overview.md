...
description: "Projects are the main building blocks of your Bitrise experience: a Git repository that stores source code is added to Bitrise as a project."
sidebar_position: 1
...
Once you have access to a [workspace](/en/bitrise-platform/workspaces/workspaces-overview), you can start adding and managing projects. You can configure pretty much every aspect of your project at any time after the initial setup. Among other things, you can:

...
1. In the **Start build** dialog, select your main Workflow under **Target**. This will kickstart your chained Workflows and build the app versions of your white label app.

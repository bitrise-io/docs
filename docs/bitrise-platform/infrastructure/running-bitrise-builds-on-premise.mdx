...
If you do have an AWS account for managing your infrastructure, we recommend checking our [AWS offering](/bitrise-platform/infrastructure/bitrise-on-aws--manual-setup/advanced-options-for-ec2-instances).

...
If you don't have an AWS account, use some other cloud provider, or already manage your own machines, we recommend checking out [our on-premise runner offering](/bitrise-platform/infrastructure/running-bitrise-builds-on-premise).
...
We recommend using the Cloud Controller to run Bitrise builds on AWS. However, if you want full control and customization options, you can choose [the manual setup](/bitrise-platform/infrastructure/bitrise-on-aws--manual-setup/advanced-options-for-ec2-instances).

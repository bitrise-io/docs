...
Make sure you’re looking at the correct place: **Workspace settings** > **Infrastructure** > **Bitrise on AWS**.
...
Only Workspace Owners, or a [custom role](/bitrise-platform/workspaces/collaboration-and-permissions-in-workspaces/custom-roles/custom-roles-overview) with the **Manage infrastructure** permission, can create a new controller. Please make sure you have the correct access rights.
...
Only Workspace Owners, or a [custom role](/bitrise-platform/workspaces/collaboration-and-permissions-in-workspaces/custom-roles/custom-roles-overview) with the **Manage infrastructure** permission, can create machine pools. Please make sure you have the correct access rights.
...
Only Workspace Owners, or a [custom role](/bitrise-platform/workspaces/collaboration-and-permissions-in-workspaces/custom-roles/custom-roles-overview) with the **Manage infrastructure** permission, can edit the pool configuration. Please make sure you have the correct access rights.
...
Only Workspace Owners, or a [custom role](/bitrise-platform/workspaces/collaboration-and-permissions-in-workspaces/custom-roles/custom-roles-overview) with the **Manage infrastructure** permission, can delete a machine pool. The same access also lets you reconfigure the pools if any of the settings are incorrect, like the desired number of replicas.

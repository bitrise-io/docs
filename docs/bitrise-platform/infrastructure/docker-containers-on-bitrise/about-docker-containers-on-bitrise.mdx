...
These credentials must be stored as [Secrets](/bitrise-ci/configure-builds/secrets). They are used when running the `docker login` command during container setup.

...
1. [Connecting the instance to your Bitrise workspace.](#connecting-the-ec2-mac-or-linux-instance-to-your-bitrise-<GlossTerm baseform="workspace">workspace</GlossTerm>)
...
1. [Create an AWS Secrets Manager secret](https://docs.aws.amazon.com/secretsmanager/latest/userguide/create_secret.html) and store the token in the <GlossTerm baseform="secret">secret</GlossTerm>.

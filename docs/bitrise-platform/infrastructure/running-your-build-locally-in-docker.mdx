...
1. Download your Bitrise build configuration (`bitrise.yml`) to the root directory of your repository.
   ...
   You can [download](/en/bitrise-ci/configure-builds/configuration-yaml/accessing-a-build-s-bitrise-yml-file) your project’s `bitrise.yml` from the **<GlossTerm baseform="bitrise.yml">bitrise.yml</GlossTerm>** tab of your <GlossTerm baseform="workflow editor">Workflow Editor</GlossTerm> on [bitrise.io](https://www.bitrise.io).

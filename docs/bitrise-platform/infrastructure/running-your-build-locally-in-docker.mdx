...
1. Download your Bitrise build configuration (`bitrise.yml`) to the root directory of your repository.
   ...
   You can [download](/en/bitrise-ci/configure-builds/configuration-yaml/accessing-a-build-s-bitrise-yml-file) your project’s `bitrise.yml` from the **bitrise.yml** tab of your Workflow Editor on [bitrise.io](https://www.bitrise.io).

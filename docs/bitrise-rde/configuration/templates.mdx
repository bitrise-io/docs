...
- **Template variables** are baked into the template with a fixed value. Mark a variable as secret to encrypt it at rest and keep it out of logs.
...
Create, edit, clone, and delete templates from the [Bitrise RDE UI](/en/bitrise-rde/ways-to-use-rde/bitrise-rde-ui), or from the CLI with `bitrise-cli rde template`.

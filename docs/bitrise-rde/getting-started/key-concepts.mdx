...
Each session belongs to the <GlossTerm baseform="workspace">workspace</GlossTerm> it was created in and is owned by the user who created it. You can connect to it in several ways — see [Connecting to a session](/en/bitrise-rde/ways-to-use-rde/connecting-to-a-session).

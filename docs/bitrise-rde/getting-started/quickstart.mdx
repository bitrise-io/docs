...
The CLI remembers your choice for that repository. It creates a <GlossTerm baseform="rde session">session</GlossTerm>, clones your current branch into it, and starts Claude Code in the cloud machine. You land directly in the agent, ready to work.

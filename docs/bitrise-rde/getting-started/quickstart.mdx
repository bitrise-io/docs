...
Enable the [GitHub integration](/en/bitrise-rde/configuration/github-integration) so the agent can pull, push, and open pull requests as you — git and the GitHub CLI authenticate automatically in every new session.
